...
urlpatterns = [
    ...
    path('rutasusuario/cancelar/<int:ruta_id>/', views.cancelar_ruta, name='cancelar_ruta'),
    path('rutasusuario/reagendar/<int:ruta_id>/', views.reagendar_ruta, name='reagendar_ruta'),
    ...
    path('api/notifications/latest-unread/', views.get_latest_unread_notification, name='get_latest_unread_notification'),
    ...
    # Debug: listar archivos subidos en media/fotos_perfil (solo staff)
    path('admin/debug/media-list/', views.debug_media_list, name='debug_media_list'),
    ...
    path('superuser/asignar-zona/<int:user_id>/', views_superuser.asignar_zona_conductor, name='asignar_zona_conductor'),
